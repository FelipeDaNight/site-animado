...
import { UrinaryExplorer } from "@/components/anatomy/urinary-explorer";

export const metadata: Metadata = {
  title: "Sistema Urinário 3D",
  description:
    "Modelo 3D interativo do rim, pelve renal, ureter, bexiga e uretra: anatomia, função e correlação clínica.",
};

export default function SistemaUrinarioPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <div className="max-w-2xl">
        ...
        <p className="mt-2 text-foreground-muted">
          Modelo 3D interativo com 5 estruturas do trato urinário — rim, pelve renal, ureter, bexiga e uretra.
          Escolha uma estrutura para ver descrição anatômica, função, relações e correlação clínica.
        </p>
      </div>
      <div className="mt-8">
        <UrinaryExplorer />
