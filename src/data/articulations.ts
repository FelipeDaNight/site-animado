...
export const articulacoes: Articulacao[] = [
  ...
  },
  {
    ...
    meshNames: [
      ...
      "Fourth_metatarsal_bone_L", "Fourth_metatarsal_bone_R",
      "Fifth_metatarsal_bone_L", "Fifth_metatarsal_bone_R",
      "Proximal_phalanx_of_first_finger_of_foot_L", "Proximal_phalanx_of_first_finger_of_foot_R",
      "Proximal_phalanx_of_second_finger_of_foot_L", "Proximal_phalanx_of_second_finger_of_foot_R",
      "Proximal_phalanx_of_third_finger_of_foot_L", "Proximal_phalanx_of_third_finger_of_foot_R",
      "Proximal_phalanx_of_fourth_finger_of_foot_L", "Proximal_phalanx_of_fourth_finger_of_foot_R",
      "Proximal_phalanx_of_fifth_finger_of_foot_L", "Proximal_phalanx_of_fifth_finger_of_foot_R",
    ],
    ligamentMeshNames: sides([
    ...
    ossosEnvolvidos: [{ slug: "perna-pe", nome: "Metatarsais e falanges proximais" }],
    nomeOficial: "Articulationes metatarsophalangeae",
    nomeComum: "Articulações metatarsofalângicas (MTF)",
    tipo: "Sinovial elipsóidea (condilar)",
    resumo: "Articulações entre as cabeças dos cinco metatarsais e as bases das falanges proximais correspondentes.",
    descricaoAnatomica:
      "Cada cabeça metatársica, convexa, articula-se com a base côncava da falange proximal do dedo correspondente. O ligamento metatarsal transverso profundo une as cabeças dos cinco metatarsais entre si, mantendo o arco transverso do antepé e estabilizando a fileira de articulações MTF como um conjunto.",
    movimentos: ["Flexão e extensão (predominantes)", "Abdução e adução", "Circundação (resultante da combinação dos anteriores)"],
    estabilizadores: [
      "Ligamentos colaterais (medial e lateral) de cada articulação",
      "Ligamentos plantares — mais espessos que a cápsula dorsal, resistem à hiperextensão no apoio do peso",
      "Ligamento metatarsal transverso profundo — solidariza as cinco cabeças metatársicas",
    ],
    correlacaoClinica:
      "O hálux valgo (joanete) é uma deformidade progressiva da 1ª articulação MTF, com desvio lateral do hálux e proeminência medial da cabeça do 1º metatarsal, favorecida por calçados apertados/salto alto e fatores genéticos. A sesamoidite e a metatarsalgia (dor na cabeça dos metatarsais, comum no 2º ao 4º) também se relacionam diretamente à sobrecarga dessas articulações durante a fase de apoio da marcha.",
    doencasRelacionadas: [],
    pontosDeProva: [
      "O hálux valgo é uma deformidade da 1ª articulação metatarsofalângica, não uma condição do próprio osso do hálux — o desvio ocorre na articulação.",
      "O ligamento metatarsal transverso profundo une as cinco cabeças dos metatarsais e ajuda a manter o arco transverso do antepé.",
    ],
    fontes: [
      { tema: "Anatomia das articulações metatarsofalângicas e hálux valgo", fonte: "Moore's Clinically Oriented Anatomy, 8ª ed." },
      { tema: "Nomenclatura oficial (Articulationes metatarsophalangeae)", fonte: "Terminologia Anatomica (FIPAT)" },
      { tema: "Classificação morfológica e funcional das articulações do pé", fonte: "Caderno de Anatomia Humana 1, UFTM (2019)" },
    ],
  },
  {
    slug: "interfalangicas-pe",
    meshNames: [
      "Proximal_phalanx_of_first_finger_of_foot_L", "Proximal_phalanx_of_first_finger_of_foot_R",
      "Distal_phalanx_of_first_finger_of_foot_L", "Distal_phalanx_of_first_finger_of_foot_R",
      "Middle_phalanx_of_second_finger_of_foot_L", "Middle_phalanx_of_second_finger_of_foot_R",
      "Distal_phalanx_of_second_finger_of_foot_L", "Distal_phalanx_of_second_finger_of_foot_R",
      "Middle_phalanx_of_third_finger_of_foot_L", "Middle_phalanx_of_third_finger_of_foot_R",
      "Distal_phalanx_of_third_finger_of_foot_L", "Distal_phalanx_of_third_finger_of_foot_R",
      "Middle_phalanx_of_fourth_finger_of_foot_L", "Middle_phalanx_of_fourth_finger_of_foot_R",
      "Distal_phalanx_of_fourth_finger_of_foot_L", "Distal_phalanx_of_fourth_finger_of_foot_R",
      "Middle_phalanx_of_fifth_finger_of_foot_L", "Middle_phalanx_of_fifth_finger_of_foot_R",
      "Distal_phalanx_of_fifth_finger_of_foot_L", "Distal_phalanx_of_fifth_finger_of_foot_R",
    ],
    ligamentMeshNames: sides([
    ...
    ossosEnvolvidos: [{ slug: "perna-pe", nome: "Falanges dos dedos do pé" }],
    nomeOficial: "Articulationes interphalangeae pedis",
    nomeComum: "Articulações interfalângicas do pé",
    tipo: "Sinovial gínglimo (dobradiça)",
    resumo: "Articulações em dobradiça entre as falanges dos dedos do pé — o hálux tem apenas uma, os demais dedos têm duas (proximal e distal).",
    descricaoAnatomica:
      "Assim como nas mãos, cada dedo do pé (exceto o hálux) tem duas articulações interfalângicas: a proximal (entre falange proximal e média) e a distal (entre falange média e distal). O hálux, por ter só duas falanges, tem uma única articulação interfalângica. São articulações uniaxiais simples, restritas a um único plano de movimento.",
    movimentos: ["Flexão", "Extensão"],
    estabilizadores: [
      "Ligamentos colaterais (medial e lateral) de cada articulação",
      "Placa plantar fibrocartilaginosa (reforço plantar da cápsula)",
    ],
    correlacaoClinica:
      "Deformidades como o dedo em martelo (flexão fixa da interfalângica proximal) e o dedo em garra (flexão das duas interfalângicas com hiperextensão da MTF) resultam de desequilíbrio entre os músculos extrínsecos e intrínsecos do pé, frequentemente associadas a calçados inadequados, neuropatia periférica (ex.: diabetes) ou doenças neuromusculares.",
    doencasRelacionadas: [],
    pontosDeProva: [
      "O hálux tem apenas uma articulação interfalângica (por ter só duas falanges); os demais dedos têm duas (proximal e distal), como nas mãos.",
      "O dedo em martelo (flexão fixa da IF proximal) e o dedo em garra (flexão das duas IF com hiperextensão da MTF) são deformidades distintas por padrão de acometimento articular.",
    ],
    fontes: [
      { tema: "Anatomia das articulações interfalângicas e deformidades dos dedos do pé", fonte: "Moore's Clinically Oriented Anatomy, 8ª ed." },
      { tema: "Nomenclatura oficial (Articulationes interphalangeae pedis)", fonte: "Terminologia Anatomica (FIPAT)" },
      { tema: "Classificação morfológica e funcional das articulações do pé", fonte: "Caderno de Anatomia Humana 1, UFTM (2019)" },
    ],
  },
];
